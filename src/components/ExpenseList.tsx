            ...
            >
                  ...
                  <span
                    className={`${
                      expense.categories?.type === "income"
                        ? "text-sm font-medium  text-success dark:text-success-dark" 
                        : "text-sm font-medium  text-error dark:text-error-dark"
                    }`}
                  >
                    {expense.categories?.type === "income"
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <Link
                  ...
                  className="text-text-primary dark:text-text-primary-dark hover:text-gray-700 dark:hover:text-gray-300 mr-4 transition-colors"
                >
                  <Pencil className="h-5 w-5 inline" />
                </Link>
                <button
                  onClick={() => onDelete(expense.id)}
                  className="text-text-primary dark:text-text-primary-dark hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
                >
